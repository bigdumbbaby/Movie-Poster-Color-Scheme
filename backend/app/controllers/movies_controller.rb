class MoviesController < ApplicationController
  def index
    ...
    response = JSON.parse(RestClient.get("https://api.themoviedb.org/3/movie/now_playing?api_key=56f6662bff7c2a1c935c2575984e9f97&language=en-US&page=#{page_number}"))
